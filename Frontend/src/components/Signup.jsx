        ...
        <div className="bg-violet-300 p-8 rounded-lg shadow-md w-full max-w-md relative">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="email" id="email" name="email" className="py-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" id="confirmPassword" name="confirmPassword" className="py-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required />
            </div>
            <div>
